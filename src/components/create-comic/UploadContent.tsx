...
export function UploadContent({ onGenerate, onPreviousStep, isGenerating = false }: UploadContentProps) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-[2px] border border-black shadow-[2px_-2px_0px_0px_#000000] p-6 space-y-6">
        <h2 className="text-xl font-heading font-bold">STEP 1: UPLOAD CONTENT</h2>
        ...
        {onPreviousStep && (
          <div className="flex justify-between items-center pt-4">
            ...
            <button className="btn-aptoon">EDIT YOUR COMIC</button>
          </div>
        )}
      </div>
    </div>
